...
// sections
import PqrsTableRow from './pqrs-table-row';
// @types
...
const TABLE_HEAD = [
  ...
  { id: 'guard', label: 'Asunto', minWidth: 150 },
...
export default function PqrsTable() {
  ...
  const handleNewItem = () => {
    Router.push(PATH_DASHBOARD.pqrs.newPqrs)
  }
  ...
  return (
    <Container maxWidth='lg'>
      <>
        <Typography variant='h3' sx={{ mb: 2 }}>Peticiones, quejas, reclamos y solicitudes</Typography>
        <Card>
