...
export default function ReportingResidentBox() {
  ...
  const onDelete = () => {
    setValue('reportingResident', null)
  }

  const onCreate = (data: ContactType) => {
    setValue('reportingResident', data)
            ...
            >
              <Stack direction='column' gap={1} sx={{ width: '100%' }} justifyContent='center' alignItems='center'>
                ...
                <Typography 
                  ...
                  variant='subtitle1'
                >
                  Residente que reporta PQRS
                </Typography>
              </Stack>
              
              <Image
                src='/assets/illustrations/angry-resident.png'
                sx={{
                  top: -20,
                  width: 200,
                  left: -20,
...
const Item = ({ data, onDelete }: ItemProps) => {
  return (
    <Stack sx={{ width: '100%' }} gap={1}>
      <Typography variant='subtitle2'>Residente que reporta o solicita PQRS</Typography>
      <Card
        sx={{
          p: 2,
          display: 'flex',
