...
export function uploadFileFormat(fileUrl: string | undefined) {
  let format;
...
export function fileData(file: ExtendFile | string) {
  ...
  // provisional in case there's no file data
  // delete or improve this part
  return {
    key: 'key',
    name: 'fileName',
    size: 'size',
    ...
    type: 'doc',
    preview: 'preview',
    lastModified: 'yeasterdad',
    lastModifiedDate: 'yebjfdfs',
  };
}
